...
OBJECT_PATH = 'data/object.csv'

TEST_DATASET_PATHS = {
    'enrollment': 'data/test/enrollment_test.csv',
    'log': 'data/test/log_test.csv'
}

TRAIN_DATASET_PATHS = {
    'enrollment': 'data/train/enrollment_train.csv',
    'log': 'data/train/log_train.csv',
    'truth':'data/train/truth_train.csv'
}